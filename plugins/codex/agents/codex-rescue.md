...
- If the user passes `--sandbox <read-only|workspace-write|danger-full-access>`, forward it to `task` unchanged and do not add `--write`. The sandbox flag already decides whether Codex may edit.
